package manager{
    ...
    import laya.ani.bone.TfConstraintData;
     ...
     * 动画模板类
     */
    public class GameTemplet extends AnimationTemplet
    {
        /**@private */
         ...
         * @return
         */
        public function buildArmature(aniMode:int = 0):GameSkeleton
        {
            return new GameSkeleton(this, aniMode);
        }
