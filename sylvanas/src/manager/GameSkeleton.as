package manager
{
    ...
    import laya.ani.bone.DeformAniData;
    import laya.ani.bone.DeformSlotData;
    import laya.ani.bone.DeformSlotDisplayData;
    import laya.ani.bone.DrawOrderData;
    import laya.ani.bone.EventData;
    import laya.ani.bone.IkConstraint;
    import laya.ani.bone.PathConstraint;
    import laya.ani.bone.PathConstraintData;
    import laya.ani.bone.SkinData;
    import laya.ani.bone.TfConstraint;
    ...
    public class GameSkeleton extends Sprite
    {
        ...
        protected var _templet:GameTemplet;//动画解析器
        /** @private */
        ...
        public var outLoop:Boolean = false;

        public function GameSkeleton(templet:GameTemplet = null, aniMode:int = 0):void
        {
         ...
         * </table>
         */
        public function init(templet:GameTemplet, aniMode:int = 0):void
        {
            var i:int, n:int;
            //aniMode = 2;
        ...
        private function _onLoaded():void
        {
            ...
            if (GameTemplet.TEMPLET_DICTIONARY == null)
            {
                GameTemplet.TEMPLET_DICTIONARY = {};
            }
            var tFactory:GameTemplet;
            tFactory = GameTemplet.TEMPLET_DICTIONARY[_aniPath];
            if (tFactory)
            {
            ...
            {
                tFactory = new GameTemplet();
                tFactory._setUrl(_aniPath);
                GameTemplet.TEMPLET_DICTIONARY[_aniPath] = tFactory;
                tFactory.on(Event.COMPLETE, this, _parseComplete);
                tFactory.on(Event.ERROR, this, _parseFail);
        ...
        {
            var tTemple:GameTemplet = GameTemplet.TEMPLET_DICTIONARY[_aniPath];
            if (tTemple)
            {
        ...
        protected function _createGraphics(_clipIndex:int = -1):void
        {
            ...
            _templet.getOriginalData(_aniClipIndex, _curOriginalData, null, _clipIndex, curTime);
         ...
         * 得到动画模板的引用
         */
        public function get templet():GameTemplet
        {
            return _templet;
        }
    }
