package manager
{
    ...
    public class GameAnimation extends GameAnimationPlayerBase
    {
        /**
        ...
        override public function play(start:* = 0, loop:Boolean = true, name:String = "", showWarn:Boolean = true):void
        {
			...
			if (!outLoop && this._frames && this.interval > 0)
			{
        ...
        protected function _setFramesFromCache(name:String, showWarn:Boolean = false):Boolean
        {
            ...
            if (name && framesMap[name])
            {
                ...
                } else
                {
                    ...
                    {
                        //如果动画数据未解析过,则先进行解析
						framesMap[name] = GraphicAnimation.parseAnimationByData(tAniO);
                        tAniO = framesMap[name];
                    }
        ...
        {
			if (_visible && _style.alpha > 0.01 && _frames) {
				super._frameLoop();
			}

        }

        public function outFrameLoop(delta:Number):void
        {
            super._outFrameLoop(delta);
        }
        ...
        public function set frames(value:Array):void
        {
            ...
            if (value)
            {
				...
				if (_actionName) _setFramesFromCache(_actionName, true);
				index = _index;
            }
        }
         ...
         */
		override public function clear():GameAnimationPlayerBase {
			super.clear();
			stop();
			this.graphics = null;
			this._frames = null;
         ...
         */
        public function loadImages(urls:Array, cacheName:String = ""):GameAnimation
        {
            this._url = "";
         ...
         * @return    返回动画本身。
         */
        public function loadAtlas(url:String, loaded:Handler = null, cacheName:String = ""):GameAnimation
        {
            this._url = "";
            var _this_:GameAnimation = this;
         ...
         * @return    返回动画本身。
         */
        public function loadAnimation(url:String, loaded:Handler = null, atlas:String = null):GameAnimation
        {
            this._url = url;
            var _this_:GameAnimation = this;
			...
			function onLoaded(loadUrl:String):void {
				...
				if (url === loadUrl) {
					...
					if (!framesMap[url + "#"]) {
						...
						var aniData:Object = GraphicAnimation.parseAnimationData(Loader.getRes(url));
						if (!aniData) return;
						//缓存动画数据
